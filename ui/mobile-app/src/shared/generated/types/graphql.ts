...
export type AddUserToTaskMutation = {
  __typename?: 'Mutation';
  addUserToTaskList?: {
    __typename?: 'TaskList';
    users: Array<{
...
`;
export type AddUserToTaskMutationFn = Apollo.MutationFunction<
  AddUserToTaskMutation,
  AddUserToTaskMutationVariables
>;
 ...
 * });
 */
export function useAddUserToTaskMutation(
  ...
  return Apollo.useMutation<
    AddUserToTaskMutation,
    AddUserToTaskMutationVariables
  >(AddUserToTaskDocument, options);
}
export type AddUserToTaskMutationHookResult = ReturnType<
  typeof useAddUserToTaskMutation
>;
export type AddUserToTaskMutationResult =
  Apollo.MutationResult<AddUserToTaskMutation>;
export type AddUserToTaskMutationOptions = Apollo.BaseMutationOptions<
  AddUserToTaskMutation,
  AddUserToTaskMutationVariables
>;
